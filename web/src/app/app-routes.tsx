...
const TokenTransferHookFeature = lazy(
  () => import('./token-transfer-hook/token-transfer-hook-feature')
);
const links: { label: string; path: string }[] = [
  { label: 'Account', path: '/account' },
  { label: 'Clusters', path: '/clusters' },
  { label: 'TokenTransferHook Program', path: '/token-transfer-hook' },
];
...
const routes: RouteObject[] = [
  ...
  { path: 'token-transfer-hook/*', element: <TokenTransferHookFeature /> },
];
